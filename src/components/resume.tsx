    ...
    <div className="rounded-xl border text-card-foreground shadow bg-background flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="@container mx-auto max-w-6xl w-full px-4 py-8">
        <article className="space-y-8">
          {/* Article header containing tags, title, subtitle, and author information. */}
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <div className="rounded-xl border bg-card text-card-foreground shadow">
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    practices. The web development landscape evolves rapidly,
                    and continuous learning is key to staying relevant.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p>
              Nemo enim ipsam voluptatem quia voluptas sit asatur aut odit
