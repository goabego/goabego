## Using Git
**Reminder:** Always follow Git best practices!  
- Commit early and often with clear, descriptive messages  
- Use feature branches for new work
- Pull and merge frequently to avoid conflicts  
- Review your changes before pushing  
- Keep your main branch clean and deployable
- Stay disciplined and your workflow will thank you!

## Tech Stack
- **React** – Frontend UI library for building interactive interfaces
- **Vite** – Fast build tool and development server
- **TailwindCSS** – Utility-first CSS framework for rapid UI development
- **Shadcn/ui** – Beautifully designed, accessible React components built with Radix UI and TailwindCSS (https://ui.shadcn.com/)
- **Firebase Hosting** – I like to use Firebase for deployment; it's simple and great for static hosting.

## Steps for installing TailwindsCSS
